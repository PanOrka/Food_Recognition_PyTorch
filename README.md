...
Zdjęcia skalowałem do rozmiaru 128x128, zapewniło to możliwość dość szybkiej nauki bez zbytniej utraty danych. <br>
...
Z tego powodu sieć ma dość wysoki średni val_loss oraz train_loss. Sieć była trenowana przez 130 epochów, przy czym najniższy val_loss otrzymałem w 75 epochu, dalej nastąpił overfitting. <br><br>
...
### **WITH_RESNET**
Do transfer learningu wykorzystałem sieć ResNet18, który był już pre-trenowany na 1000 klasach obiektów. <br>
